...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-8">
            <form class="preference-form" action="/sustainable/${trip.id}/update-preference" method="post">
            ...
            <div class="col-md-6 mb-4">
                <div class="card option-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/sustainable/${trip.id}/select-option" method="post">
    ...
    <div class="text-center mt-4">
        <a href="/sustainable/" class="btn btn-outline-secondary">
